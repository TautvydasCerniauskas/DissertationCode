...
def dual_encoder_model(
    ...
    embeddings_W = get_embeddigs(hparams)

    # Embeded the context and the utterance 
    ...
    with tf.variable_scope("prediction") as vs:
        ...
        generated_utterance = tf.expand_dims(generated_response, 2)
    ...
    mean_loss = tf.reduce_mean(losses, name="mean loss")
